...
lblNumCap = tk.Label(master=root, text='Anzahl Großbuchstaben', font=('Arial Black', 10),bg='RED')
# Eingabefeld Anzahl Großbuchstaben
inNumCap = tk.Entry(root)
# Label für Eingabe Anzahl Kleinbuchstaben
lblNumLow = tk.Label(master=root, text='Anzahl Kleinbuchstaben', font=('Arial Black', 10),bg='RED')
# Eingabefeld Anzahl Kleinbuchstaben
inNumLow = tk.Entry(root)
# Label für Eingabe Anzahl Zahlen
lblNumDigits = tk.Label(master=root, text='Anzahl Zahlen', font=('Arial Black', 10),bg='RED')
# Eingabefeld Anzahl Zahlen
inNumDigits = tk.Entry(root)
# Label für Eingabe Anzahl Sonderzeichen
lblNumSpecs = tk.Label(master=root, text='Anzahl Sonderzeichen', font=('Arial Black', 10),bg='RED')
...
inNumCap.place(x=220, y=30, width=150)
lblNumLow.place(x=30, y=80)
inNumLow.place(x=220, y=80, width=150)
lblNumDigits.place(x=30, y=130)
inNumDigits.place(x=220, y=130, width=150)
lblNumSpecs.place(x=30, y=180)
inNumSpecs.place(x=220, y=180, width=150)
lblNoChar.place(x=30, y=230)
inNoChar.place(x=220, y=230, width=150)
lblPasswort.place(x=30, y=280, width=340, height=100)
btnGen.place(x=30, y=420, width=100, height=50)
btnGenCopy.place(x=150, y=420, width=220, height=50)
